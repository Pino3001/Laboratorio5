...
void CargarDatosDefecto(IUsuario *usuarios, IRegistroMedico *registros)
{
    ...
    // R1
    registros->altaProblemaDeSalud("A", "A01", "Asma");
    // R2
    registros->altaProblemaDeSalud("A", "A02", "Congestión");
    // R3
    registros->altaProblemaDeSalud("B", "B01", "Nauseas");
                    ...
                    if (exist)
                    {
                        ...
                        if (contraseniaValida(contra))
                        {
                            ...
                            if (valida || primerIngr) // Se cumplen las condiciones para iniciar sesion.
                            {
                                ...
                                list<TipoUsuario> tu = usuarios->tipoDeUsuarioEnSesion(ci); // Obtengo los tipos de usuarios
                        ...
                        if (ingresaComo == 1)
                        {
                            ...
                            do
                            {
                                try
                                {
                                    ...
                                    cout << "\n [4] - Registro Consulta de Emergencia.";
                                    cout << "\n [5] - Cerrar Sesion.";
                                    cout << "\n\n Opcion >> ";
                                    cin >> opt;
                                        ...
                                        try
                                        {
                                            ...
                                            do
                                            {
                                                try
                                                {
                                                    ...
                                                    string ci, nomb, apell, sexo, str;
                                                    int i = 0;
                                                    bool seguir = true, tSoci = false, tMed = false, tAdmin = false, existe;
                                                    list<TipoUsuario> tUsr;
                                    ...
                                    else if (opt == 4) // Registro consulta Emergencia
                                    {
                                        string str, descripcion, ciSocio, ciMedico;
                                        cout << "\n\t\t -Alta Consulta de Emergencia-";
                                        cout << " \n\t Ingrese la fecha y hora de Hoy:";
                                        cout << "\n\n\t Fecha [dd/mm/aa]: ";
                                        cin >> str;
                                        DTFecha fechaHoy = splitFecha(str);
                                        cout << "\n\t Hora [dd:mm:aa]: ";
                                        cin >> str;
                                        DTHora hora = splitHora(str);
                                        cout << "\n\t Cedula Paciente: ";
                                        cin >> ciSocio;
                                        cout << "\n\t Cedula Medico: ";
                                        cin >> ciMedico;
                                        ...
                                        registros->registroConsultaEmergencia(ciSocio, ciMedico, fechaHoy, hora, descripcion);
                                        cout << "\n\n\t\t Consulta Registrada!\n";
                                    }
                                    else if (opt == 5) // Cerrar sesion
                                    {
                                ...
                                if (optMedico == 1)
                                {
                                    try
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                string ciSocio, descrip, id, codigo;
                                                bool otroProb;
                                                char listar, aT;
                                                    ...
                                                    do
                                                    {
                                                        try
                                                        {
                                                            ...
                                                            if (opTrat == 1)
                                                            {
                                                                ...
                                                                cin.ignore();
                                                                getline(cin, descripTrata);
                                                                cout << "\n\t Cedula del cirujano: ";
                                                                cin >> ciMedico;
                                                                cout << "\n\t Ingrese la fecha en que se va a realizar la Cirujia: [dd/mm/aa]";
                                                                cout << "\n\tFecha: ";
                                                                cin >> str;
                                                        ...
                                                        catch (const runtime_error &e)
                                                        {
                                                            ...
                                                            cout << "\nError: " << e.what() << "\n"
                                                                 << endl;
                                                            cout << "\n\n\t Desea ingresar un nuevo tratamiento? (Si no ingresa un nuevo tratamieno el diagnostico sera eliminado)";
                                                            cout << "\n\t\t\t [S / N];";
                                                            cin >> nuevo;
                                                            if (nuevo == 'n' || nuevo == 'N')
                                                            {
                                                                registros->eliminarUnDiagnostico();
